...
class Template3Test(unittest.TestCase):
    def runTest(self):
        ...
        self.assertEqual(a.getFieldType("U64"), int)
        self.assertEqual(a.getFieldType("U32"), int)
        self.assertEqual(a.getFieldType("U16"), int)
        self.assertEqual(a.getFieldType("U8"), int)
        self.assertEqual(a.getFieldType("I64"), int)
        self.assertEqual(a.getFieldType("I32"), int)
        self.assertEqual(a.getFieldType("I16"), int)
        self.assertEqual(a.getFieldType("I8"), int)
        self.assertEqual(a.getFieldType("CHR"), int)
